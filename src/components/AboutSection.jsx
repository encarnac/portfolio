...
const AboutSection = ({ setSelectedPage }) => {
  return (
    <div id="about" className="my-72 grid grid-cols-1 lg:grid-cols-12">
      ...
      <div className="col-span-7 mb-12 mr-0 place-self-center rounded-3xl bg-gradient-to-br from-[#68A3EB] to-[#F38BBB] px-1 py-1 text-center shadow-sm dark:from-[#3034C2] dark:via-[#6A3DD1] dark:to-[#9329BE] lg:mb-0 lg:mr-16 lg:text-left">
