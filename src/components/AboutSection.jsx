...
const AboutSection = ({ setSelectedPage }) => {
  ...
  return (
    ...
    >
      ...
      <div
        id="about"
        className="relative mb-48 grid grid-cols-1 items-start justify-items-center gap-x-6 lg:grid-cols-12"
      >
        <div className="size-[60px] md:size-[140px] absolute bottom-0 left-1/4 z-0 -translate-y-1/4 translate-x-1/4 rounded-full bg-[#c93283] blur-[3rem] dark:bg-[#5722c9] md:blur-[5rem] lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2"></div>
        <div className="flex flex-col items-center gap-y-4 lg:col-span-4 lg:justify-self-end">
