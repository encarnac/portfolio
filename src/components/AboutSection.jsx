...
const AboutSection = ({ setSelectedPage }) => {
  ...
  return (
    <>
      ...
      <div
        id="about"
        className="grid grid-cols-1 items-center justify-items-center gap-x-0 py-28 lg:grid-cols-12"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          className="flex flex-col items-center justify-items-center gap-y-2 lg:col-span-5"
        >
          <div className="size-[200px] sm:size-[250px] md:size-[275px] xl:size-[350px] relative my-2 rounded-full bg-[#F38BBB] dark:bg-[#7943ed]">
        ...
        <motion.div
          ...
          className="relative mt-8 flex h-full w-full min-w-fit flex-col items-center p-px py-6 lg:col-span-7 lg:mt-0 lg:min-w-min xl:w-11/12"
        >
          ...
          <div className="mt-6 place-self-stretch px-4 pb-2 text-base text-[#6F6977] dark:text-[#b7b0c2] md:mb-6">
