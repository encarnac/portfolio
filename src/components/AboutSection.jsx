  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="size-[200px] sm:size-[250px] md:size-[275px] xl:size-[350px] relative my-2 rounded-[100%] bg-[#F38BBB] dark:bg-[#7943ed]">
        ...
        <motion.div
          ...
          className="relative mt-4 flex h-full w-full min-w-fit flex-col items-center p-px py-6 lg:col-span-7 lg:mt-0 lg:min-w-min xl:w-11/12"
        >
