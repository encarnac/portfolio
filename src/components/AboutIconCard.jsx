const AboutIconCard = ({ info }) => {
  return (
    <div className="flex flex-col items-center gap-x-1 gap-y-2 px-1 py-2 font-semibold text-[#D6C5DC] transition-colors dark:text-[#2B2841] sm:gap-x-2 sm:px-2 md:flex-row md:justify-center md:gap-y-0">
      {info.icon}
