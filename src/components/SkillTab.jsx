  ...
  return (
    ...
    >
      <div
        ...
        } flex h-full flex-col justify-center items-center gap-y-1 rounded-xl bg-[#E3E8EE] px-0 py-3 transition duration-300 hover:-translate-y-2 hover:duration-300 dark:bg-[#211e2c] md:gap-y-2 md:rounded-2xl xl:py-8`}
      >
